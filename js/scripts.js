...
(function($) {
    ...
    function submitForm() {
        ...
        $.ajax({
            ...
            data: "firstname="+firstname+"&lastname="+lastname+"&age="+age+"&email="+email+"&address="+address+"&gender="+gender+"&postcode="+postcode+"&mobileno="+mobileno+"&dob="+dob+"&address2="+address2+"&city="+city+"&telephoneno="+telephoneno+"&terms="+terms, 
