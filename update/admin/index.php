...
<body>
	...
	<div class="content" style="width:90%; height:600px;">
		...
		?>
			...
			<li style="padding:5px 0px;" ><a href="#" class="black_link" > Users : <?php echo $userCount?> </a> </li>
			<li style="padding:5px 0px;"><a href="#" class="black_link"> Home Page Pics : 4 </a></li>
			<li style="padding:5px 0px;"><a href="#" class="black_link"> Recuritment : 2 </a></li>
			<li style="padding:5px 0px;"><a href="#" class="black_link"> Event Added : 2 </a></li>
			<li style="padding:5px 0px;"><a href="#" class="black_link"> Photo Uploaded: 2 </a></li>
			<li style="padding:5px 0px;"><a href="#" class="black_link"> Newsletter Emails : <?php echo $newsletterCount?> </a></li> </ul>
			</div>
