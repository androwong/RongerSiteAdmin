...
<body data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<!-- OVERVIEW2 -->
	<div id="overview2" class="overview2">
		<div class="container">
			<h2>Blog</h2>
			<img class="decorative-line" src="images/blog-line.svg" alt="decorative line">
			<p class="seventy-percent-width">Are you a writer poet or journalist WHLR are looking for contributors to our local news letter. <br>
...
<form action="admin/server.php" method="post">
 ...
 <main class="site-main">
			...
			<!-- Slider Section -->
			<div class="container-fluid1 no-left-padding no-right-padding slider-section slider-section7">	
			
				<div class="slider-carousel slider-carousel-7 center">
					<div class="item">
						<div class="post-box">
							<img src="blog_files/Clean_Bandit_White_Hart_Lane_Recreation_Ground.jpg" alt="Slide" />
							<div class="entry-content">
								<span class="post-category"><a href="#" title="Music">Clean Bandit</a></span>
								<h3><a href="#" title="Clean Bandit Labour Live at White Hart Lane Recreation Ground">Clean Bandit Labour Live at White Hart Lane Recreation Ground</a></h3>
					...
					<div class="item">
						<div class="post-box">
							<img src="blog_files/David_Lammy_White_Hart_Lane_Recreation_Ground.jpg" alt="Slide" />
							<div class="entry-content">
								<span class="post-category"><a href="#" title="Political">Labour MP David Lammy</a></span>
								<h3><a href="#" title="Labour MP David Lammy at White Hart Lane Recreation Ground">Labour MP David Lammy at White Hart Lane Recreation Ground</a></h3>
								<a href="#" title="Read More">Read More</a>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="post-box">
							<img src="blog_files/Jeremy_Corbyn_White_Hart_Lane_Recreation_Ground.jpg" alt="Slide" />
							<div class="entry-content">
								<span class="post-category"><a href="#" title="Political">Labour MP Jeremy Corbyn</a></span>
								<h3><a href="#" title="Labour MP Jeremy Corbyn at White Hart Lane Recreation Ground">Labour MP Jeremy Corbyn at White Hart Lane Recreation Ground</a></h3>
								<a href="#" title="Read More">Read More</a>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="post-box">
							<img src="blog_files/Labour_Live_White_Hart_Lane_Recreation_Ground.jpg" alt="Slide" />
							<div class="entry-content">
								<span class="post-category"><a href="#" title="Political">Labour Live</a></span>
								<h3><a href="#" title="Labour Live at White Hart Lane Recreation Ground">Labour Live at White Hart Lane Recreation Ground</a></h3>
								<a href="#" title="Read More">Read More</a>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											...
											<a href="#"><img src="blog_files/blog-parallel-1.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Political">Political</a></span>
												<h3 class="entry-title"><a href="#" title="Labour MP David Lammy">Labour MP David Lammy</a></h3>
											</div>								
								...
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											<div class="post-meta">
												<span class="byline">by <a href="#" title="Political">Political</a></span>
												<span class="post-date"><a href="#">MARCH 17, 2017</a></span>
											</div>
											<a href="#"><img src="blog_files/blog-parallel-2.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Political">Political</a></span>
												<h3 class="entry-title"><a href="#" title="Labour MP Jeremy Corbyn">Labour MP Jeremy Corbyn</a></h3>
											</div>								
											<p>These cases are perfectly simple and easy to distinguish. In a free hour, when our power of choice is untrammelled and when nothing prevents our being able to do what we like best, every pleasure is to be welcomed and every pain avoided. But in certain circumstances and owing to the claims of duty...</p>
											<a href="#" title="Read More">Read More</a>
										</div>
									</div>
								</div>
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											...
											<a href="#"><img src="blog_files/blog-parallel-3.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Lifestyle">Lifestyle</a></span>
												<h3 class="entry-title"><a href="#" title="New Fashion Outfits">New Ice-Cream Outfits</a></h3>
											</div>								
								...
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											...
											<a href="#"><img src="blog_files/blog-parallel-4.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Political">Political</a></span>
												<h3 class="entry-title"><a href="#" title="Labour Supporters">Labour Supporters</a></h3>
											</div>								
								...
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											...
											<a href="#"><img src="blog_files/blog-parallel-5.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Travel">Travel</a></span>
												<h3 class="entry-title"><a href="#" title="Top Rated City Views">Top Rated City Views</a></h3>
											</div>								
											<p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness...</p>
											<a href="#" title="Read More">Read More</a>
										</div>
								...
								<div class="col-12 col-lg-12 col-md-6 col-sm-6 blog-paralle">
									<div class="type-post">
										<div class="entry-cover">
											...
											<a href="#"><img src="blog_files/blog-parallel-6.jpg" alt="Post" /></a>
										</div>
										<div class="entry-content">
											<div class="entry-header">	
												<span class="post-category"><a href="#" title="Lifestyle">Lifestyle</a></span>
